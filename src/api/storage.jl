...
storage = APIRoot(
    ...
    Bucket=APIResource("b";
        ...
        list=APIMethod(:GET, "", "Retrieves a list of buckets for a given project."; transform=(x, t) -> map(t, x[:items])),
    ...
    BucketAccessControls=APIResource("b/{bucket}/acl";
        ...
        list=APIMethod(:GET, "", "Retrieves ACL entries on a specified bucket."; transform=(x, t) -> map(t, x[:items])),
    ...
    Object=APIResource("b/{bucket}/o";
        ...
        list=APIMethod(:GET, "", "Retrieves a list of objects matching the criteria."; transform=(x, t) -> map(t, x[:items])),
    ...
    ObjectAccessControls=APIResource("b/{bucket}/o/{object}/acl";
        ...
        list=APIMethod(:GET, "", "Retrieves ACL entries on the specified object."; transform=(x, t) -> map(t, x[:items])),
    ...
    DefaultObjectAccessControls=APIResource("b/{bucket}/defaultObjectAcl";
        ...
        list=APIMethod(:GET, "", "Retrieves default object ACL entries on the specified bucket."; transform=(x, t) -> map(t, x[:items])),
