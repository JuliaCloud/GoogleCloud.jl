...
compute = APIRoot(
    ...
    Addresse=APIResource("regions/{region}/addresses";
    ...
    GlobalAddresse=APIResource("global/addresses";
	delete=APIMethod(:DELETE, "{address}", "Deletes the specified address resource."),
    ...
    TargetHttpProxie=APIResource("global/targetHttpProxies";
    ...
    TargetHttpsProxie=APIResource("global/targetHttpsProxies";
    ...
    TargetSslProxie=APIResource("global/targetSslProxies";
